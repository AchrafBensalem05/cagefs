...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Medical Chat'),
    ...
    */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'healthcare-chat'),
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','auth:healthcare']),
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'App\Http\Controllers\Chatify'),
    ],
    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'healthcare-chat/api'),
