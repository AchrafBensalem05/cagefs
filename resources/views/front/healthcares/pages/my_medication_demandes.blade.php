    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="search-set">
                    <div class="search-path">
                        <a class="btn btn-filter" id="filter_search">
                            <img src="{{ asset('patient/assets/img/icons/search-whites.svg') }}" alt="img">
            ...
            <div class="table-responsive">
                {{ $demandes_datatable->table(['class' => "table table-sm table-bordered table-striped"])  }}
            </div>
        </div>
    </div>
