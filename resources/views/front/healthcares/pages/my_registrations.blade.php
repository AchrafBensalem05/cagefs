    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
               {{ $registration_datatable->table(['class' => "table table-sm table-bordered table-striped"])  }}
            </div>
        </div>
    </div>
...
@push('after-scripts')
    ...
    <script>
        ...
        $('.filter').on('change', function (event) {
            window.LaravelDataTables["my-registration-table"].ajax.reload();
        })

    </script>
    {{ $registration_datatable->scripts() }}
@endpush
