    ...
    <div class="header">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu menu-drop-user">
                    <div class="profilename">
                        ...
                        <hr class="m-0">
                        <a class="dropdown-item" href="{{ route('patient.profile') }}"> <i class="me-2" data-feather="user"></i>@lang("My Profile")</a>
                        <hr class="m-0">
                    </div>
                </div>
            </li>
        ...
        <div class="dropdown mobile-user-menu">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="{{ route('healthcare.profile') }}">@lang("My Profile")</a>
                <form action="{{ route('logout_healthcare') }}" method="post">@csrf <button>@lang("Sign Out")</button>
                </form>
            </div>
        </div>
    </div>
