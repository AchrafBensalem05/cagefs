    ...
    <div class="card">
        ...
        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg col-sm-6 col-12 filters">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="form-group">
                                                <select class="form-control filter" name="section" id="" >
                                                    <option value="" selected >@lang("Medication or Blood Donation")</option>
                                                    @foreach(\App\Models\Article::Section as $section)
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="form-group">
                                                <select class="form-control filter" name="medication_type" id="" >
                                                    <option value="" selected >@lang("Medication Post type")</option>
                                                    <option value="search">@lang("search")</option>
            ...
            <div class="table-responsive">
                {{ $announces_datatable->table(['class' => "table table-sm table-bordered table-striped"])  }}
            </div>
        </div>
    </div>
