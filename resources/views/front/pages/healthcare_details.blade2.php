            ...
            <div class="phone-opening-etat">
                <div class="content-border">
                    ...
                    <div class="dv-1 mb-0">
                        ...
                        <p class="mb-0">{{ $healthcare->closure_reason }}</p>
                    </div>
                    <div class="dv-2 mb-0">
                    ...
                    <div class="right">
                        <div class="content-border mb-0">
                            ...
                            @if($healthcare->is_open_now == "closed")
                                ...
                                <span class="spn-2">{{ $healthcare->closure_reason }}</span>
                                </div>
                                <div class="mb-0">
            ...
            <div class="appointtement-list" >
                ...
                <div class="Table">
                    ...
                    <div class="table-header">
                        ...
                        @if($healthcare->limit_patient > optional($healthcare->registrations_for_the_opened_day)->count())
                            <div class="tbl-btn">
                                    ...
                                    @if($healthcare->registrations_for_the_opened_day and $healthcare->registrations_for_the_opened_day->count())
                                        @foreach($healthcare->registrations_for_the_opened_day as $record)
                                            <tr>
                                                ...
                                                <td class="column2" @if($record->status == 'done') style="text-decoration:line-through solid 2px" @endif>@if($record->name == request()->get('q')) {{ request()->get('q') }} @else **** @endif</td>
                                                <!--
                                                ...
                                                -->
                                                <td class="column3" @if($record->status == 'done') style="text-decoration:line-through solid 2px" @endif>@if($record->name == request()->get('q')) {{ $record->started_at }} @else **** @endif</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </table>
            ...
            <form action="{{ route('patient.send_message_to' , [$healthcare->id , 'healthcare']) }}"  method="post" enctype="multipart/form-data">
                ...
                <div class="sender-area-email-box">
                    <div class="input-place-email-box">
                        <input placeholder="Send a message." class="send-input-email-box" type="text" name="content">
                        <button type="submit" class="send-icon-email-box border-0">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g><g><path fill="#6B6C7B" d="M481.508,210.336L68.414,38.926c-17.403-7.222-37.064-4.045-51.309,8.287C2.86,59.547-3.098,78.551,1.558,96.808 L38.327,241h180.026c8.284,0,15.001,6.716,15.001,15.001c0,8.284-6.716,15.001-15.001,15.001H38.327L1.558,415.193 c-4.656,18.258,1.301,37.262,15.547,49.595c14.274,12.357,33.937,15.495,51.31,8.287l413.094-171.409 C500.317,293.862,512,276.364,512,256.001C512,235.638,500.317,218.139,481.508,210.336z"></path></g></g></svg>
                        </button>
                    </div>
                </div>
                <div>
          ...
          <div class="appointtement-list">
                ...
                <div class="Table" style="height: auto;">
                    ...
                    <style>
                            ...
                            .form-inscription .input-ordonnance {
                                  width: 350px;
                                  height: 100px;
                                  border-radius: 2px;
                                  margin-bottom: 10px;
                            ...
                            .form-inscription .input-ordonnance input{
                                  font-size: 18px;
                                  margin:0 20px;
                            }
                            
                            .form-inscription .select-number{
                                  height: 100px;
                                  width:350px;
                                  font-size: 15px;
                                  display: flex;
                            ...
                            .form-inscription .number-container {
                                width:290px;
                                display: flex;
                                justify-content: center;
                                flex-wrap: wrap;
                            }
                            .form-inscription .number-box {
                                  cursor: pointer;
                                  height: 30px;
                                  width: 30px;
                                  margin: 3px 7px;
                                  border: 1.5px solid #3E4394;
                                  border-radius: 5px;
                                  display: flex;
                                  justify-content: center;
                                  align-items: center;
                            }
                            .form-inscription .number-box label{
                                  color: #3E4394;
                                  font-size: 17px;
                                  cursor:pointer;
                            }
                            .form-inscription .number-box input{
                                  display:none;
                            }
                            ...
                            .form-inscription .select-region{
                                  height: 100px;
                                  width:auto;
                                  display: flex;
                                  justify-content: center;
                            ...
                            .form-inscription .select-region .region-label{
                                width:330px;
                                text-align:justify;
                            }
                            .form-inscription .select-region .select-time {
                                  width: 290px;
                                  height: 36px;
                                  font-size:17px;
                                  font-weight:600;
                            ...
                            .form-inscription .select-payment{
                                  height: auto;
                                  width:330px;
                                  font-size: 15px;
                                  display: flex;
                            ...
                            .form-inscription .select-payment .payments{
                                  height: auto;
                                  width: 270px;
                                  margin:0 5px;
                                  display: flex;
                            ...
                            .form-inscription .select-payment .payments div{
                                  height: 30px;
                                  width: auto;
                                  margin:5px;
                                  margin-top:0;
                            ...
                            .form-inscription .select-payment .payments div label{
                                cursor:pointer;
                            }
                            .form-inscription .select-payment .payments div img{
                                  width: 30px;
                                  margin: 0 5px;
                            }
                            .form-inscription .div-inscription .btn3 {
                                  width: 104px;
                                  height: 40px;
                                  border: none;
                                  border-radius: 4px;
