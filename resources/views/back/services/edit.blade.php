        ...
        <div class="row">
            <div class="col-6 offset-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route("services.update" , [$type , $service->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pb-2">
                                    <label for="">Titre</label>
                                    <input type="text" required class="form-control" name="title" value="{{ $service->title }}">
                                    @error('title')
                                ...
                                <div class="col-md-12 col-sm-12 pb-2">
                                    ...
                                    <textarea name="icon" class="form-control" id="" cols="30" rows="5">{{ $service->icon }}</textarea>
                                    @error('description')
                                    <small class="text-danger text-bold">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 pt-3 text-center">
                                    <label for="">Icon (if exists)</label>
                                    {!! $service->icon !!}
                                </div>
