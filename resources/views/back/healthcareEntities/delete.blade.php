        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  method="post"  action="{{ route("healthcareEntity.destroy" , [$type , $healthcareEntity->id]) }}">
                            @csrf
                            @method("DELETE")
                            <span>@lang("Are you sure from deleting") <strong>{{ HealthcareEntity::Types[$type] . ' ' .  $healthcareEntity->name  }}</strong> ?</span>
                            <hr>
                            <a class=" btn btn-success" href="{{ route('healthcareEntity.index' , $type) }}"><i class="fa fa-arrow-left"></i>  @lang("Cancel")</a>
